const debug = require('debug')('khulnasoft:nodejs-runtime-agent');
...
function start(startingConfig) {
  try {
    debug('If you have any issues during this beta, please contact runtime@khulnasoft.com');
    ...
    const beaconInterval = setInterval(() => {
      try {
        ...
        try {
          stopIntervals();
          console.log('Error in Khulnasoft runtime agent, please contact runtime@khulnasoft.com', error);
        } catch (err) {}
      }
    ...
    const snapshotInterval = setInterval(() => {
      try {
        ...
        try {
          stopIntervals();
          console.log('Error in Vulnmap runtime agent, please contact runtime@khulnasoft.com', error);
        } catch (err) {}
      }
    ...
    console.log('Error while starting Vulnmap runtime agent, please contact runtime@khulnasoft.com', error);
  };
}
