...
test('demo app reports a vuln method when called', async (t) => {
  ...
  process.env.VULNMAP_HOMEBASE_ORIGIN = 'http://localhost:8000';
  process.env.VULNMAP_BEACON_INTERVAL_MS = BEACON_INTERVAL_MS;
  process.env.VULNMAP_SNAPSHOT_INTERVAL_MS = SNAPSHOT_INTERVAL_MS;
  process.env.VULNMAP_TRIGGER_EXTRA_VULN = true;
  ...
  delete process.env.VULNMAP_HOMEBASE_ORIGIN;
  delete process.env.VULNMAP_BEACON_INTERVAL_MS;
  delete process.env.VULNMAP_SNAPSHOT_INTERVAL_MS;
  delete process.env.VULNMAP_TRIGGER_EXTRA_VULN;
